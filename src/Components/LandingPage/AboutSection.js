...
const homeObjOne = {
    ...
    headline: 'Welcome!',
    description: 'At Land, we are dedicated to providing a supportive and inclusive online platform for the  community. Our purpose is to empower transgender individuals by offering resources, fostering connection, and promoting self-acceptance.We believe in creating a world where transgender voices are heard, respected, and celebrated. is a one and all platform for you to help you out in quitting smoking and drinking by providing personalized consultations and medications making you a step closer to leading a healthy life.',
